...
describe("DeleteReplyUseCase", () => {
  ...
  it("should orchestrating the delete reply action correctly", async () => {
    ...
    mockCommentRepository.verifyAvailableCommentById = jest
      .fn()
      .mockImplementation(() => Promise.resolve());
    mockReplyRepository.verifyAvailableReplyById = jest
      .fn()
      .mockImplementation(() => Promise.resolve());
    mockReplyRepository.verifyReplyByOwner = jest
      .fn()
      .mockImplementation(() => Promise.resolve());
    ...
    expect(mockReplyRepository.verifyAvailableReplyById).toBeCalledWith(
      useCasePayload.replyId
    );
    expect(mockReplyRepository.verifyReplyByOwner).toBeCalledWith(
      useCasePayload.replyId,
