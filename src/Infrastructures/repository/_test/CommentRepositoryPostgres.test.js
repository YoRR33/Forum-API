...
describe("CommentRepositoryPostgres", () => {
  ...
  describe("verifyAvailableCommentById function", () => {
    it("should throw NotFoundError if comment not available", async () => {
      ...
      // Action & Assert
      await expect(
        commentRepositoryPostgres.verifyAvailableCommentById(commentId)
  ...
  describe("verifyCommentByOwner function", () => {
    it("should throw AuthorizationError if owner is not valid", async () => {
      ...
      // Action & Assert
      await expect(
        commentRepositoryPostgres.verifyCommentByOwner(commentId, inValidUserId)
    ...
    it("should not throw AuthorizationError if owner is valid", async () => {
      ...
      // Action & Assert
      await expect(
        commentRepositoryPostgres.verifyCommentByOwner(commentId, userId)
  ...
  describe("deleteCommentById function", () => {
    it("should throw NotFoundError when comment not found or invalid", () => {
      ...
      // Action & Assert
      return expect(
        commentRepositoryPostgres.deleteCommentById("comment-000")
    ...
    it("should return delete comment correctly", async () => {
      ...
      // Assert
      const commentResult = await CommentsTableTestHelper.findCommentById(
        commentId
      );
